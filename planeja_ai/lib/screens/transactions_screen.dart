...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  Future<void> _deleteCategory(AppCategory cat) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
            'Tem certeza que deseja remover "${cat.name}" das opções salvas?'),
        actions: [
          TextButton(
  ...
  Future<void> _handleSubmit() async {
    ...
    if (titleText.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Por favor, preencha o título, valor e categoria')),
      );
      return;
    }
    ...
    final matched = provider.transactionCategories.firstWhere(
      ...
      orElse: () => AppCategory(
          id: '', name: '', colorHex: '', iconName: '', type: 'transaction'),
    );
                            ...
                            child: Consumer<FinanceProvider>(
                              builder: (context, provider, _) {
                                final query = _categoryController.text
                                    .trim()
                                    .toLowerCase();
                                final exactMatch = provider.categories
